...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      textInput("lesion_gene1", "Marker Gene 1:", value = "Gene1"),
      numericInput("lesion_threshold1", "Threshold 1:", value = 2, min = 0, step = 0.1),
      textInput("lesion_gene2", "Marker Gene 2:", value = "Gene2"),
    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("Help", 
                 ...
                 p("1. Marker Gene 1 (default: Gene1) expression is above Threshold 1 (default: 2)"),
                 p("2. Marker Gene 2 (default: Gene2) expression is above Threshold 2 (default: 5)"),
